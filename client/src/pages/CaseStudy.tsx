                    ...
                    {Array.isArray(project.results) ? (
                      <div className="grid sm:grid-cols-3 gap-6">
                        {project.results.map((result, index) => (
                          <div
                            key={index}
                            className="card-clean p-6 rounded-2xl"
                          >
                  ...
                  project.sections.map((section, index) => (
                    ...
                    >
                      <div>
                        ...
                        {section.items && (
                          <ul className="list-disc list-inside text-gray-500 text-lg leading-relaxed mt-4 space-y-2 ml-4">
                          ...
                          <Carousel className="w-full">
                            <CarouselContent>
                              {section.images.map((img, idx) => (
                                <CarouselItem
                                  key={idx}
                                  className="min-w-0 shrink-0 grow-0 basis-full bg-gray-50 flex items-center justify-center p-4 h-[300px] md:h-[500px] pl-[24px] pr-[24px] ml-[0px] mr-[0px]"
                                >
                                  <img
                                    src={img}
